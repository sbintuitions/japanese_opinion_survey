...
jcqa_number_result_dir = "results/request/jcqa_all_permutations_number"
jcqa_katakana_result_dir = "results/request/jcqa_all_permutations_katakana"

v3_number_result_dir = "results/request/v3_all_permutations_number"
v3_katakana_result_dir = "results/request/v3_all_permutations_katakana"
...
for institute in institutes:
    ...
    for model in models:
        ...
        number_results = load_results(os.path.join(jcqa_number_model_dir, "results.json"))
        katakana_results = load_results(os.path.join(jcqa_katakana_model_dir, "results.json"))
        agreements = []
        js_divergences = []
...
analysis_dir = os.path.join("results/analysis", "jcqa_agreements")
...
for institute in institutes:
    ...
    for model in models:
        ...
        number_results = load_results(os.path.join(v3_number_model_dir, "results.json"))
        katakana_results = load_results(os.path.join(v3_katakana_model_dir, "results.json"))
        agreements = []
        js_divergences = []
        katakana_result_dict = defaultdict(list)
        for katakana_result in katakana_results:
...
analysis_dir = os.path.join("results/analysis", "v3_agreements")
if not os.path.exists(analysis_dir):
    os.mkdir(analysis_dir)
write_analyses_json(analyses=analyses, file_path=os.path.join(analysis_dir, "results.json"))
write_analyses_csv(analyses=analyses, file_path=os.path.join(analysis_dir, "results.csv"))
